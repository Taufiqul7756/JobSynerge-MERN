...
const Banner = ({ query, handleInputChange }) => {
  console.log(query);
  return (
    <div className="bg-grey max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
      <h1 className="text-5xl font-bold text-primary mb-3">
        Find Recent <span className="text-blue"> job</span> Circular
      </h1>
      ...
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          <div className="flex md:round-5-md rounded shadow-sm ring-1 ring-inset focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full ">
            <input
              type="text"
              name="title"
